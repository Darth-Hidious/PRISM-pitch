        ...
        <>
            ...
            <dialog ref={dialogRef} className="application-note-dialog" aria-labelledby="application-note-title">
                ...
                <article>
                    ...
                    <p>My underlying disagreement concerns how a company building a new capability is evaluated. I do not believe that capability can be fully defined in advance as a fixed offering with a standard price list. Its scope develops through the work and the requirements of the customers using it.</p>
