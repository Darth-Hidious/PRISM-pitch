        ...
        <>
            ...
            <dialog ref={dialogRef} className="application-note-dialog" aria-labelledby="application-note-title">
                ...
                <article>
                    ...
                    <p>I’ll continue the technical work on PRISM. I’m stepping back from leading funding and incubation applications. Others in the company can take those forward.</p>
                    <footer>
