                    ...
                    <div className="mobile-svg" style={{ flex: '0 0 45%', maxHeight: '100%' }}>
                        <svg viewBox="0 0 400 240" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <g stroke="#EDEDEF" strokeWidth="1.5" opacity="0.25" fill="none" strokeDasharray="6 6">
                                <line x1="110" y1="60" x2="290" y2="60"><animate attributeName="stroke-dashoffset" from="12" to="0" dur="1s" repeatCount="indefinite" /></line>
                                <line x1="320" y1="90" x2="320" y2="150"><animate attributeName="stroke-dashoffset" from="12" to="0" dur="1s" repeatCount="indefinite" /></line>
                                <line x1="290" y1="180" x2="110" y2="180"><animate attributeName="stroke-dashoffset" from="12" to="0" dur="1s" repeatCount="indefinite" /></line>
                                <line x1="80" y1="150" x2="80" y2="90"><animate attributeName="stroke-dashoffset" from="12" to="0" dur="1s" repeatCount="indefinite" /></line>
                            </g>
                            <line x1="110" y1="180" x2="290" y2="180" stroke="#EDEDEF" strokeWidth="0.5" opacity="0.1" />
                            <g>
                                <circle r="1.5" fill="#34D399"><animate attributeName="cx" values="110; 290" dur="2.0s" begin="0s" repeatCount="indefinite"/><animate attributeName="cy" values="180; 177; 180" dur="2.0s" begin="0s" repeatCount="indefinite"/><animate attributeName="opacity" values="0; 1; 1; 0" keyTimes="0; 0.1; 0.9; 1" dur="2.0s" begin="0s" repeatCount="indefinite"/></circle>
                                <circle r="1.5" fill="#4A8FD4"><animate attributeName="cx" values="110; 290" dur="2.2s" begin="0.4s" repeatCount="indefinite"/><animate attributeName="cy" values="180; 183; 180" dur="2.2s" begin="0.4s" repeatCount="indefinite"/><animate attributeName="opacity" values="0; 1; 1; 0" keyTimes="0; 0.1; 0.9; 1" dur="2.2s" begin="0.4s" repeatCount="indefinite"/></circle>
                                <circle r="1.5" fill="#C9A84C"><animate attributeName="cx" values="110; 290" dur="1.8s" begin="0.9s" repeatCount="indefinite"/><animate attributeName="cy" values="180; 176; 180" dur="1.8s" begin="0.9s" repeatCount="indefinite"/><animate attributeName="opacity" values="0; 1; 1; 0" keyTimes="0; 0.1; 0.9; 1" dur="1.8s" begin="0.9s" repeatCount="indefinite"/></circle>
                                <circle r="1.5" fill="#EDEDEF"><animate attributeName="cx" values="110; 290" dur="2.5s" begin="1.2s" repeatCount="indefinite"/><animate attributeName="cy" values="180; 182; 180" dur="2.5s" begin="1.2s" repeatCount="indefinite"/><animate attributeName="opacity" values="0; 0.8; 0.8; 0" keyTimes="0; 0.1; 0.9; 1" dur="2.5s" begin="1.2s" repeatCount="indefinite"/></circle>
                                <circle r="1.5" fill="#34D399"><animate attributeName="cx" values="110; 290" dur="2.1s" begin="1.7s" repeatCount="indefinite"/><animate attributeName="cy" values="180; 178; 180" dur="2.1s" begin="1.7s" repeatCount="indefinite"/><animate attributeName="opacity" values="0; 1; 1; 0" keyTimes="0; 0.1; 0.9; 1" dur="2.1s" begin="1.7s" repeatCount="indefinite"/></circle>
                            </g>
